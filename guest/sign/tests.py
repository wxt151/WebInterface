...
class ModelTest(TestCase):
    ...
    def setUp(cls):
        Event.objects.create(id = 4,name = "oneplus 3 event",status = True,limit = 2000,
                             address = 'shenzhen',start_time = '2016-08-31 02:18:22')
        Guest.objects.create(id = 6,event_id = 4,realname = 'alen',phone = '13711001101',
...
class EventMangeTest(TestCase):
    ...
    def setUp(self):
        ...
        Event.objects.create(name="xiaomi5",limit=2000,address = 'beijing',
                             status = 1,start_time = '2017-08-10 12:30:00')
    ...
    def test_event_mange_search_sucess(self):
        ''' 测试发布会搜索 '''
        response = self.client.post('/login_action/',data = self.login_user)
...
class SignIndexActionTest(TestCase):
    def setUp(self):
        ...
        Event.objects.create(id=2, name="oneplus4",limit=2000,
                             address='shenzhen', status=1, start_time='2017-06-10 12:30:00')
        Guest.objects.create(realname="alen", phone=18611001100,
                             email='alen@mail.com', sign=0,event_id=1)
